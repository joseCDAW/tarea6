...
@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white shadow rounded-lg p-6 mb-8">
            ...
            <form action="{{ route('swapi.details') }}" method="POST" class="max-w-sm mx-auto space-y-4">
                @csrf
                ...
                <div>
                    ...
                    <select name="film_url" id="film_url" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
