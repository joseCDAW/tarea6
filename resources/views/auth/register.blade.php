    ...
    <div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form method="POST" action="{{ route('register.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500" required value="{{ old('name') }}">
            </div>
            <div>
        ...
        <p class="mt-6 text-center">¿Ya tienes cuenta? <a href="{{ route('login') }}" class="text-blue-600 hover:underline">Inicia sesión aquí</a></p>
    </div>
@endsection
