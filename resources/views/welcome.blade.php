...
*/.hljs{color:#24292e;background:#fff}.hljs-doctag,.hljs-keyword,.hljs-meta .hljs-keyword,.hljs-template-tag,.hljs-template-variable,.hljs-type,.hljs-variable.language_{color:#d73a49}.hljs-title,.hljs-title.class_,.hljs-title.class_.inherited__,.hljs-title.function_{color:#6f42c1}.hljs-attr,.hljs-attribute,.hljs-literal,.hljs-meta,.hljs-number,.hljs-operator,.hljs-selector-attr,.hljs-selector-class,.hljs-selector-id,.hljs-variable{color:#005cc5}.hljs-meta .hljs-string,.hljs-regexp,.hljs-string{color:#032f62}.hljs-built_in,.hljs-symbol{color:#e36209}.hljs-code,.hljs-comment,.hljs-formula{color:#6a737d}.hljs-name,.hljs-quote,.hljs-selector-pseudo,.hljs-selector-tag{color:#22863a}.hljs-subst{color:#24292e}.hljs-section{color:#005cc5;font-weight:700}.hljs-bullet{color:#735c0f}.hljs-emphasis{color:#24292e;font-style:italic}.hljs-strong{color:#24292e;font-weight:700}.hljs-addition{color:#22863a;background-color:#f0fff4}.hljs-deletion{color:#b31d28;background-color:#ffeef0}
    ...
    <style>
        ...
        #frame-3 .hljs-ln-line[data-line-number='1062'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        #frame-4 .hljs-ln-line[data-line-number='6'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        #frame-5 .hljs-ln-line[data-line-number='40'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        #frame-6 .hljs-ln-line[data-line-number='244'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        #frame-7 .hljs-ln-line[data-line-number='215'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-12 .hljs-ln-line[data-line-number='88'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        #frame-13 .hljs-ln-line[data-line-number='209'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        #frame-14 .hljs-ln-line[data-line-number='49'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        #frame-15 .hljs-ln-line[data-line-number='209'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        #frame-16 .hljs-ln-line[data-line-number='121'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-32 .hljs-ln-line[data-line-number='209'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-35 .hljs-ln-line[data-line-number='209'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-40 .hljs-ln-line[data-line-number='49'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-46 .hljs-ln-line[data-line-number='26'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-51 .hljs-ln-line[data-line-number='1220'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        #frame-52 .hljs-ln-line[data-line-number='20'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
            ...
            >
                ...
                <span class="inline-block rounded-full bg-gray-200 px-3 py-2 text-sm leading-5 text-gray-900 max-w-full truncate dark:bg-gray-800 dark:text-white">
                    GET localhost
                        ...
                        <div class="px-4">
                            <span class="text-sm text-gray-500 dark:text-gray-400">PHP 8.4.4 — Laravel 12.0.1</span>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3" x-clock>
                        ...
                        "
                                        >
                                            <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                                                <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">vendor/laravel/framework/src/Illuminate/Foundation/helpers.php</span>
                                    <span class="font-mono text-xs">:1062</span>
                                </span>
                                                </div>
                                                <div class="text-gray-500 dark:text-gray-400">
                                                    view
                        ...
                        "
                                        >
                                            <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                                                <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">routes/web.php</span>
                                    <span class="font-mono text-xs">:6</span>
                                </span>
                                                </div>
                                                <div class="text-gray-500 dark:text-gray-400">
                                                    {closure:/var/www/html/routes/web.php:5}
                                                </div>
                                            </div>
                                        </div>
                                    </button>
                        ...
                        "
                                ...
                                <span class="inline-flex items-baseline">
                                    ...
                                    <span class="font-mono text-xs">:244</span>
                                </span>
                                                </div>
                                                <div class="text-gray-500 dark:text-gray-400">
                                                    runCallable
                        ...
                        "
                                ...
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Routing\Route</span>
                                    <span class="font-mono text-xs">:215</span>
                                </span>
                                                </div>
                                                <div class="text-gray-500 dark:text-gray-400">
                                                    run
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">vendor/laravel/framework/src/Illuminate/View/FileViewFinder.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">vendor/laravel/framework/src/Illuminate/View/Factory.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">vendor/laravel/framework/src/Illuminate/Foundation/helpers.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">routes/web.php</span>
                            ...
                            <div class="mb-3">
                                <div class="text-md text-gray-500 dark:text-gray-400">
                                    <div class="mb-2">
                                        ...
                                        <span class="wrap text-gray-900 dark:text-gray-300">vendor/laravel/framework/src/Illuminate/Routing/CallableDispatcher.php</span>
...
require_once $publicPath.&#039;/index.php&#039;;
            ...
            >
                ...
                >
                    ...
                    "
                        >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:135.0) Gecko/20100101 Firefox/135.0</code></pre>
                </span>
                    </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                <span
                ...
                >
                    ...
                    "
                        >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8</code></pre>
                </span>
                    </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                <span
                ...
                >
                    ...
                    "
                        >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">en-US,en;q=0.5</code></pre>
                </span>
                    </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                <span
                ...
                >
                    ...
                    "
                        >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">XSRF-TOKEN=%3D; laravel_session=%3D; XDEBUG_SESSION=PHPSTORM; Phpstorm-a9d228f8=9dd4e00c-edf9-4c11-b148-f2502fa82f1d</code></pre>
                </span>
                    </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                <span
                ...
                >
                    ...
                    "
                        >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">u=0, i</code></pre>
                </span>
                    </div>
                </dl>
                ...
                <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                    <div class="flex items-center gap-2  dark:border-gray-800">
                        <div class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                            <span>mysql</span>
                            <span class="hidden text-xs text-gray-500 lg:inline-block">(2.29 ms)</span>
                        </div>
                        <span
                            class="min-w-0 flex-grow"
                            style="
                    ...
                    "
                        >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `sessions` where `id` = &#039;GeNHWHFYSOJuRSLNbBeTpyM729FF82LrrTUz0gV8&#039; limit 1</code></pre>
                </span>
                    </div>
                </dl>
            </section>
